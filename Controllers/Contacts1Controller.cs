...
namespace ContactManager.Controllers
{
    public class Contacts1Controller : Controller
    {
        ...
        public Contacts1Controller(ContactManagerContext context)
        {
            _context = context;
        }
        ...
        {
            var contactManagerContext = _context.Contacts.Include(c => c.Category);
            return View(await contactManagerContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ContactId,FirstName,LastName,Phone,Email,Organization,CategoryId,DateAdded")] Contact contact)
        {
